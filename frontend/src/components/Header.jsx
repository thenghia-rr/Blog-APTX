      ...
      <header className="container mx-auto px-5 flex justify-between items-center py-4 ">
        <Link to="/">
          <img
            src={images.LogoAPTX}
            alt="Logo"
            className="h-[24px] md:h-[32px] lg:h-[36px] 2xl:h-[38px] "
          />
        </Link>
        ...
        >
          <ul className="items-center gap-y-5 text-white lg:text-light-soft flex flex-col lg:flex-row gap-x-2 font-semibold ">
