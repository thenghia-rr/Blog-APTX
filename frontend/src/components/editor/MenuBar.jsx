...
import {
  ...
  const MenuBar = ({ editor }) => {
    // Add image to content of the post
    ...
    return (
      <div className="border border-slate-300 rounded-lg p-5 sticky top-3 left-0 right-0 bg-white z-10 flex gap-0.5 flex-wrap mt-7">
        <button
